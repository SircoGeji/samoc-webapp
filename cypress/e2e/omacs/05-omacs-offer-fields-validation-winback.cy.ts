...
context('Check winback offer form fields validation', () => {
  ...
  const offerCodeFocus = `${offerPrefix}win_${dateString}_`;
  const offerCodeFull = `${offerPrefix}win_${dateString}_${offerCode}`;
  const offerCodeFullDuration = `${offerPrefix}win_${dateString}_${offerCode}500_for_1mo`;
