...
context('Check retention offer form fields validation', () => {
  ...
  const offerCodeFocus = `${offerPrefix}ret_${dateString}_`;
  const offerCodeFull = `${offerPrefix}ret_${dateString}_${offerCode}`;
  const offerCodeFullDuration = `${offerPrefix}ret_${dateString}_${offerCode}500_for_1mo`;
  ...
  it('should check offerType field', () => {
    ...
    cy.get('[role="listbox"]')
      ...
      .then(() => {
        cy.get('[role="listbox"]').find('mat-option').contains('Acquisition');
  ...
  it('should check emptiness of other form fields', () => {
    ...
    cy.get('[formControlName="eligiblePlans"]').should('have.class', 'mat-select-empty');
    cy.get('[formControlName="plan"]').should('not.exist');
    cy.get('[formControlName="totalUniqueCodes"]').should('not.exist');
    cy.get('[formControlName="offerCodeType"]').contains('Single Code');
    ...
    cy.get('[formControlName="offerBgImageUrl"]').should('not.exist');
  ...
  // eligiblePlans field
  it('should check eligiblePlans field validation', () => {
    ...
    cy.get('[formControlName="eligiblePlans"]')
  ...
  it('should check offerCodeType field validation', () => {
    ...
    cy.get('[formControlName="offerCodeType"]')
      ...
      .should('eq', 'true');
    cy.get('[formControlName="offerCodeType"]').should('have.class', 'mat-select-disabled');
  ...
  it('should check discountType field validation', () => {
    ...
    cy.get('[role="listbox"]')
      ...
      .then(() => {
        ...
        cy.get('[role="listbox"]').find('mat-option').contains(' Percentage ');
      });
    cy.get(
      '.cdk-overlay-backdrop.cdk-overlay-transparent-backdrop.cdk-overlay-backdrop-showing',
    ).click();
  ...
  // welcomeEmail field
  it('should check welcomeEmail field validation', () => {
    cy.get('[formControlName="welcomeText"]')
      .clear()
