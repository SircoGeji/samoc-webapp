...
context('Save, edit, duplicate and delete retention offers', () => {
  ...
  const offerCodeFull1 = `${offerPrefix}ret_${dateString}_${offerCode1}`;
  const offerCodeFullDuration1 = `${offerPrefix}ret_${dateString}_${offerCode1}500_for_3mo`;
  const offerCodeFullDuration2 = `${offerPrefix}ret_${dateString}_${offerCode1}500_for_3mo_v2`;
  ...
  it('should select "Retention" offerType', () => {
    cy.get('[formControlName="offerType"]').click();
    cy.get('[role="listbox"]').find('mat-option').contains('Retention').click();
  });
  ...
  it('should select "twlght3month" eligiblePlans', () => {
  ...
  it('should fill welcome email text textarea', () => {
  ...
  it('should check edit offer disabled fields', () => {
    ...
    cy.get('[formControlName="eligiblePlans"]').should('not.be.empty');
