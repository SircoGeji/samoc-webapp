          ...
          if (field.fieldName !== 'price' && field.fieldName !== 'currency') {
            ...
            if (
              ...
              fieldControl.setValue(
                field.dataType === 'boolean' ? !!Number(value) : value,
              );
            } else {
              if (field.dataType !== 'boolean') {
                fieldControl.reset();
