...
@Component({
  selector: 'images-drop',
  templateUrl: './images-drop.component.html',
  styleUrls: ['./images-drop.component.scss'],
})
export class ImagesDropComponent {
  ...
  private async uploadImageToS3(images) {
    try {
      ...
      } else if (this.platform === PlatformEnum.ROKU) {
        this.rokuService
          .uploadImageToS3(
            'gallery',
            images,
